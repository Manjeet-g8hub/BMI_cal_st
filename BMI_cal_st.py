...
name = required_input(st.text_input("Enter Your name", key="name"))
ht = required_input(st.slider("Enter your height in meters:", min_value=1.0, max_value= 2.5, step=0.01))
wt = st.slider("Enter your weight in kilograms:", min_value=1.0, max_value=300.0, step=0.1)
gender = required_input(st.selectbox("Select your gender:", ["Male", "Female"]))
